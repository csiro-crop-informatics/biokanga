// $Id: plfreetype.c 12661 2013-11-05 16:24:11Z airwin $
//
                ...
                if ( FT->shade > 0 )
                {
                    ...
                    // The New anti-aliasing technique
                    {
                        ...
                        else
                        {
                            ...
                            // alpha_b=1.0-alpha_a;
                            // R=(m_plsc->curcolor.r*alpha_a)+(R*alpha_b);
                            // G=(m_plsc->curcolor.g*alpha_a)+(G*alpha_b);
                            // B=(m_plsc->curcolor.b*alpha_a)+(B*alpha_b);
                            //
                            ...
                            R = (int) ( ( ( m_plsc->curcolor.r - R ) * alpha_a ) + R );
                            G = (int) ( ( ( m_plsc->curcolor.g - G ) * alpha_a ) + G );
                            B = (int) ( ( ( m_plsc->curcolor.b - B ) * alpha_a ) + B );
