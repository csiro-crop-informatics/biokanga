// $Id: plshade.c 12312 2013-05-01 01:11:41Z hezekiahcarty $
//
           ...
           PLPointer pltr_data )
{
    ...
    // Color range to use
    color_min   = m_plsc->cmap1_min;
    color_max   = m_plsc->cmap1_max;
    ...
    {
        init_color = m_plsc->icol0;
        init_width = m_plsc->width;
        plcol0( cont_color );
        plwidth( cont_width );
        if ( pltr )
        {
             ...
             PLPointer pltr_data )
{
    ...
    if ( pltr == NULL && m_plsc->coordinate_transform == NULL )
        rectangular = 1;
