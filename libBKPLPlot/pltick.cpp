// $Id: pltick.c 11680 2011-03-27 17:57:51Z airwin $
//
...
plwxtik( PLFLT x, PLFLT y, PLBOOL minor, PLBOOL invert )
{
    ...
    length = MAX( ROUND( height * m_plsc->ypmm ), 1 );
...
plwytik( PLFLT x, PLFLT y, PLBOOL minor, PLBOOL invert )
{
    ...
    length = MAX( ROUND( height * m_plsc->xpmm ), 1 );
...
plerx1( PLFLT xmin, PLFLT xmax, PLFLT y )
{
    ...
    yminor = (PLINT) ( MAX( 1.0, m_plsc->minht * m_plsc->ypmm ) );
...
plery1( PLFLT x, PLFLT ymin, PLFLT ymax )
{
    ...
    xminor = (PLINT) ( MAX( 1.0, m_plsc->minht * m_plsc->xpmm ) );
