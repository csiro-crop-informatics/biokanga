// $Id: plplotP.h 12831 2013-12-09 14:35:42Z andrewross $
//
...
// If not including this file from inside of plcore.h, declare m_plsc
...
#endif
#ifndef TRANSFORM
#define TRANSFORM( x, y, xnew, ynew )    if ( m_plsc->coordinate_transform ) { m_plsc->coordinate_transform( ( x ), ( y ), ( xnew ), ( ynew ), m_plsc->coordinate_transform_data ); } else { *xnew = x; *ynew = y; }
#endif
