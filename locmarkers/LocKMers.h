...
class CLocKMers
{
	...
	int m_MinHamming;				// must be at least this Hamming away from any other K-mer in other species
...
public:
	...
	int
		LocKMers(etPMode PMode,			// processing mode - currently always defaults to 0
