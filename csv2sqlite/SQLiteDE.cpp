...
//	   TransName VARCHAR(50) UNIQUE,		-- Short name of this transcript
...
tsDEStmSQL CSQLiteDE::m_StmSQL[4] = {
	{(char *)"TblExprs",
		...
		NULL },
	{ (char *)"TblTrans",
		(char *)"CREATE TABLE TblTrans ( TransID INTEGER PRIMARY KEY ASC,ExprID INTEGER,TransName VARCHAR(50) UNIQUE,Exons Integer,TransLen INTEGER,TransAnnotation VARCHAR(1000))",
